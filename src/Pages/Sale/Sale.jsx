...
function Sale() {
    ...
    return (
        ...
        <div className="DashboardrightSideBar">
            ...
            <div class="formGroup">
                <input type="text" name="customerName" id="customerName" placeholder="Customer Name" autofocus />
                <input type="tel" name="contactNumber" id="contactNumber" placeholder="Contact Number" />
            </div>

            <div class="formGroup">
                <input type="email" name="email" id="email" placeholder="Customer Email Address" />
                <input type="text" name="product" id="product" placeholder="Product Name" />
            </div>

            <div class="formGroup">
                <input type="number" name="quantity" id="quantity" placeholder="Quantity" />
                <input type="number" name="price" id="price" placeholder="Enter Sale Price" />
            </div>

            <div class="formGroup">
                <input type="date" name="saleDate" id="saleDate" placeholder="Sale Date" />
                <input type="text" name="paymentMethod" id="paymentMethod" placeholder="Cash / Cheque / Account Transfer" />
            </div>

            <div class="formGroup">
                <input type="text" name="additionalNote" id="additionalNote"
                    placeholder="Additional Note About the Selled Product" />
            </div>
            <button type="submit" id="submit" onclick="addSale()"> Save </button>
        </main>
