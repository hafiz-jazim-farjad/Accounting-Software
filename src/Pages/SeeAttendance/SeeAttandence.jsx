...
export default function SeeAttendance() {
    ...
    async function GetAttendance() {
        ...
        querySnapshot.forEach((doc) => {
            ...
            <tr data-id="${rowId}">
                ...
                <td className="mobile-header">${Employees.attendance}</td>
    ...
    async function OpenDetail(rowId) {
        ...
        const docRef = doc(db, "Attendance", rowId);
    ...
    <div className="row" style="display: flex justify-content: center; align-items: center;; flex-wrap: wrap;">
        <div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
                            ...
                            <h5 style="margin-right: 20px;"><strong>Attendance:</strong> ${Employee.attendance}</h5>
                            <h5 style="margin-right: 20px;"><strong>Attendance Date:</strong> ${Employee.todayDate}</h5>
                        </div>
                    </div>
                </div>
                `,  
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            const postRef = doc(db, "Attendance", rowId);
                            try {
                    ...
                    Swal.fire({
                        position: "center",
                        icon: "success",
                        title: "Update Attendance will come soom",
                        showConfirmButton: false,
                        timer: 1500,
                    });
                }
                    ...
                    <table style={{ width: "100%", cursor: "alias" }}>
                        <thead>
                            <tr>
                                ...
                                <th colSpan={4}> Attendance Detail </th>
                            </tr>
                            <tr
