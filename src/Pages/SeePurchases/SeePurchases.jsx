    ...
    querySnapshot.forEach((doc) => {
      ...
      rows += `
            <tr data-id="${rowId}">
                ...
                <td className="mobile-header">${Purchases.VenderProduct}</td>
                <td className="mobile-header">${Purchases.PurchaseDate}</td>
                <td className="mobile-header">${Purchases.AdvancePaymentOrNot}</td>
  ...
  async function OpenDetail(rowId) {
    ...
    if (docSnap.exists()) {
      ...
      const AdvancePayment =
        Customer.AdvancePayment.length > 0
    ...
    <h5 style="margin-right: 20px;"><strong>Product Purchased:</strong> ${Customer.VenderProduct}</h5>
    <h5 style="margin-right: 20px;"><strong>Purchased Code:</strong> ${Customer.PurchaseCode}</h5>
            ...
            <h5 style="margin-right: 20px;"><strong>Advance payment:</strong> ${AdvancePayment}</h5>
            <h5 style="margin-right: 20px;"><strong>Purchased payment:</strong> ${Customer.PurchasedMoney}</h5>
            <h5 style="margin-right: 20px;"><strong>Payment:</strong> ${Customer.Payment}</h5>
            <h5 style="margin-right: 20px;"><strong>AdvancePaymentOrNot</strong> ${Customer.AdvancePaymentOrNot}</h5>
            <h5 style="margin-right: 20px;"><strong>Purchased Product Quantity:</strong> ${Customer.Quantity}</h5>
        </div>
    </div>
</div>
